...
class LidarLocalization : public nav2_util::LifecycleNode
{
public:
  explicit LidarLocalization(const rclcpp::NodeOptions & options);
  ...
  geometry_msgs::msg::PoseWithCovariance::SharedPtr odom_pose_with_cov_ptr_;
